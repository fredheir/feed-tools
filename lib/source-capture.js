...
/**
 * @typedef {import("./item-shape").FeedDocumentInput} FeedDocumentInput
...
/**
 * @param {FeedDocumentInput} document
 * @param {{sourceName: string, assetsDir?: string, saveDir?: string}} options
...
/**
 * @template {FeedItemInput | FeedItem} T
 * @param {Array<T>|null|undefined} items
 * @param {{
 *   seen: Set<string>,
 *   sourceName: string,
 *   target?: FeedItem[],
 *   mapItem?: (item: T) => FeedItem | null | undefined,
