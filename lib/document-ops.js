...
const { assertFeedDocument, getPreferredItemKey } = require("./item-shape");

/**
 * @typedef {import("./item-shape").FeedDocument} FeedDocument
 * @typedef {Object} PruneOptions
 * @property {string|Array<string>} [keep]
 * @property {string|Array<string>} [drop]
 */
