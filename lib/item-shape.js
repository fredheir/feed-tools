...
/**
 * @typedef {Object} FeedAuthorInput
...
/**
 * @typedef {Object} FeedContentInput
...
/**
 * @typedef {Object} FeedMediaInput
 * @property {string|null} [src]
 * @property {string|null} [href]
 * @property {string|null} [alt]
 * @property {"image"|"video"|null} [media_kind]
 ...
 * @property {string|null} [local_src]
 * @property {string|null} [local_video_src]
 */
...
/**
 * @typedef {Object} FeedCardInput
 * @property {"quoted_post"|"external_card"|null} [kind]
 * @property {string|null} [href]
 * @property {string|null} [handle]
 ...
 * @property {string|null} [image_local]
 */
...
/**
 * @typedef {Object} FeedEmbeddedLinkInput
 * @property {string|null} [href]
 * @property {string|null} [text]
 * @property {"entity"|"link"|null} [kind]
 */

/**
 * @typedef {Object} FeedEmbeddedLink
 * @property {string|null} href
 * @property {string|null} text
 * @property {"entity"|"link"|null} kind
 */
...
/**
 * @typedef {Object} FeedThreadInput
...
/**
 * @typedef {Object} FeedItemInput
 * @property {string} [id]
 * @property {string} [source]
 * @property {string|null} [source_item_id]
 * @property {number|null} [index]
 * @property {string|null} [url]
 * @property {FeedAuthorInput} [author]
 * @property {FeedContentInput} [content]
 * @property {FeedStatsInput} [stats]
 * @property {FeedMediaInput[]} [media]
 * @property {FeedCardInput[]} [cards]
 * @property {FeedThreadInput} [thread]
 * @property {FeedEmbeddedLinkInput[]} [embedded_links]
 * @property {string|null} [first_seen_at]
 * @property {string|null} [last_seen_at]
 * @property {number|null} [capture_count]
 */
 ...
 * @property {FeedCard[]} cards
 * @property {FeedThread} thread
 * @property {FeedEmbeddedLink[]} embedded_links
 * @property {string|null} first_seen_at
 * @property {string|null} last_seen_at
 * @property {number|null} capture_count
 */
...
/**
 * @typedef {Object} FeedDocumentInput
 * @property {number} [schema_version]
 * @property {string} [source]
 * @property {string|null} [captured_at]
 * @property {FeedItemInput[]} [items]
 */
...
/**
 * @typedef {Object} FeedItemFallback
 * @property {string} [source]
 * @property {number|null} [index]
 */
 ...
 * @property {SelectionSpec} [keep]
 * @property {SelectionSpec} [drop]
 */
 ...
 * @property {string} category
 * @property {SelectionSpec} selection
 */

/**
 * @typedef {Object} PickedGroupItem
 ...
 * @property {string} label
 * @property {PickedGroupItem[]} groups
 */
...
/**
 * @param {FeedDocumentInput} document
...
/**
 * @param {FeedItemInput} item
 * @param {string} source
 * @returns {string}
 */
function buildSyntheticFingerprint(item, source) {
 ...
 * @returns {string}
 */
function getSyntheticItemId(item, source) {
...
/**
 * @param {FeedItemInput} item
 * @param {FeedItemFallback} [fallback]
 * @returns {string}
 */
