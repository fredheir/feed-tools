 ...
 * @typedef {import("./item-shape").SelectionRow} SelectionRow
...
/**
 * @param {FeedDocument} document
 * @param {import("./item-shape").Allocation|unknown} allocation
 * @param {{limit?: number, unclassifiedOnly?: boolean, fallbackCategory?: string}} [options]
 * @returns {string}
 */
